...
class Ps_Customtext extends Module implements WidgetInterface
{
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<h2>hola</h2>
<p><strong class="dark">olor sit amet conse ctetu</strong></p>
<p>Sit Alvaroamet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.</p>'
            ),
        );
